...
using BlogProject.Repositories.Implementation;
using BlogProject.Repositories.Interfaces;
using BlogWebProject.Data;
using BlogWebProject.Repositories.Implementation;
...
namespace BlogWebProject.Repositories
{
    public class RepositoryWrapper : IRepositoryWrapper, IDisposable
    {
        ...
        private PostTagViewModelInterface _postCategory;
        ...
        public PostTagViewModelInterface PostCategory
        {
            get
            {
